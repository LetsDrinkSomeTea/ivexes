...
from modules.vector_db.downloader import (
    download_capec, download_cwe, get_capec_tree, get_cwe_tree,
    CAPEC_URL, CWE_URL
)
...
class TestDownloader(unittest.TestCase):
    ...
    def test_download_capec(self, mock_urlopen):
        ...
        self.assertEqual(result, '<capec:Attack_Patterns xmlns:capec="http://capec.mitre.org/capec-3"></capec:Attack_Patterns>')
    ...
    def test_download_cwe(self, mock_urlopen):
        ...
        xml_content = b'<Weakness_Catalog xmlns="http://cwe.mitre.org/cwe-7"></Weakness_Catalog>'
        ...
        self.assertEqual(result, '<Weakness_Catalog xmlns="http://cwe.mitre.org/cwe-7"></Weakness_Catalog>')
    ...
    def test_get_cwe_tree(self, mock_download_cwe):
        ...
        mock_download_cwe.return_value = '<Weakness_Catalog xmlns="http://cwe.mitre.org/cwe-7"></Weakness_Catalog>'
