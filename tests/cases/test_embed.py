...
class TestCweCapecDatabase(unittest.TestCase):
    ...
    def test_init_with_openai_embedding(self, mock_default_ef, mock_openai_ef, mock_client):
        ...
        with patch('modules.vector_db.embed.settings') as mock_settings:
            ...
            mock_chroma_client.get_or_create_collection.assert_called_once_with(
                ...
                embedding_function=mock_openai_instance
            )
    ...
    def test_init_with_default_embedding(self, mock_default_ef, mock_client):
        ...
        with patch('modules.vector_db.embed.settings') as mock_settings:
            ...
            mock_chroma_client.get_or_create_collection.assert_called_once_with(
                name="collection-local", 
                embedding_function=mock_default_instance
            )
    ...
    def test_initialize(self, mock_insert_capec, mock_insert_cwe, mock_get_capec_tree, 
                        mock_get_cwe_tree, mock_default_ef, mock_client):
        ...
        with patch('modules.vector_db.embed.settings') as mock_settings:
            ...
            mock_chroma_client = MagicMock()
            mock_collection = MagicMock()
            mock_collection.count.return_value = 0  # Empty collection to trigger initialize
            mock_chroma_client.get_or_create_collection.return_value = mock_collection
            mock_client.return_value = mock_chroma_client
