...
HTB_CHALLENGES = [
    (
        PartialSettings(
            trace_name='pass',
            setup_archive='testdata/htb_pass/upload.tgz',
        ),
        'pass',
    ...
    (
        PartialSettings(
            ...
            setup_archive='testdata/htb_behind_the_scenes/upload.tgz',
        ),
        'behindthescenes',
    ...
    (
        PartialSettings(
            ...
            setup_archive='testdata/htb_bincrypt_breaker/upload.tgz',
        ),
        'checker',
...
VULNERABILITIES = [
    ...
    PartialSettings(
        ...
        codebase_path='testdata/atop/codebase',
    ...
    PartialSettings(
        ...
        codebase_path='testdata/curl/codebase',
